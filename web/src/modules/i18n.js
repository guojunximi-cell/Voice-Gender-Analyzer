...
const DICT = {
	...
	"ko-KR": {
		"app.title": "Voiceduck — 음성 작업을 위한 음성 분석",
		...
		"record.freeTip": "자유롭게 말하면 자동 전사합니다 (느리고 자원 소모 큼)",
		"record.hint": "위 원고를 따라 읽으세요. 정렬기로 그대로 보내며, 음성 인식 단계를 건너뜁니다.",
		"record.scriptPickerLabel": "원고",
		"record.scriptPickerAria": "읽을 원고 선택",
		"record.scriptCustom": "사용자 지정 원고",
		"record.scriptCustomPlaceholder": "소리 내어 읽을 텍스트를 입력하세요…",
		"record.customHint": "이 텍스트는 정렬기로 그대로 전달됩니다 — 분석 언어와 일치해야 정렬이 성공합니다.",
		"record.scriptCustomEmpty": "사용자 지정 칸에 먼저 텍스트를 입력하세요.",

		"stats.title": "분포",
		"stats.subtitle": "음성 구간만 — 음악 / 무음 제외",
		"stats.modeAria": "분류 기준",
		"stats.modeA": "신경망",
		"stats.modePitch": "음높이",
		"stats.modeResonance": "공명",
		"stats.modeATip": "inaSpeechSegmenter 신경망 분류기 라벨.",
		"stats.modePitchTip": "음소별 F0 — 165 Hz가 중성 중앙값.",
		"stats.modeResonanceTip": "음소별 공명 지표 — 0.5가 중성 중앙값.",
		"stats.lockedTip": "이 파일에 Engine C 데이터가 없습니다 (꺼져 있거나 실패).",
		"label.male": "남",
		"label.female": "여",
		"label.other": "기타",
		"label.music": "음악",
		...
		"segments.title": "구간",
		"segments.countSuffix": "개",
		"segments.acousticDot": "음향 분석 포함",
		"segments.confTitle": "분류기 신뢰도 {pct} %",

		"mobile.tabSegments": "구간",
		"mobile.tabMetrics": "음향",

		"metrics.emptyClick": "구간을 클릭하면<br/>음향 세부 정보가 표시됩니다",
		"metrics.emptyUpload": "오디오를 업로드/분석하면<br/>전체 평균이 나타납니다",
		"metrics.noEngineC": "Engine C가 꺼져 있어<br/>전체 평균을 표시할 수 없습니다",
		"metrics.alignWarning": "정렬 품질이 낮습니다 — 결과는 참고용으로만 보세요.",
		"metrics.alignHintScript": "원고를 건너뛰거나 잘못 읽은 듯합니다 — 다시 시도하면 보통 개선됩니다.",
		"metrics.alignHintFree": "잡음이나 빠른 속도로 정렬이 약해졌을 수 있습니다.",
		"metrics.alignPhoneRatio": "음소/글자 {ratio}",
		"metrics.alignCoverage": "범위 {pct} %",
		"metrics.cardPitch": "음높이 (F0)",
		"metrics.cardResonance": "공명",
		"metrics.pitchRangeTitle": "음높이 범위 (80–320 Hz)",
		"metrics.zoneMale": "남성 전형 85–155 Hz",
		"metrics.zoneOverlap": "중첩 영역 145–185 Hz",
		"metrics.zoneFemale": "여성 전형 175–255 Hz",
		"metrics.legendMale": "남 85–155 Hz",
		"metrics.legendNeutral": "혼합 145–185 Hz",
		"metrics.legendFemale": "여 175–255 Hz",
		"metrics.formantsTitle": "포먼트",
		"metrics.nnTitle": "신경망 추정",
		"metrics.nnDisclaimer": "이 추정은 주로 프랑스어 방송 오디오로 학습된 오픈소스 분류기 inaSpeechSegmenter에서 나옵니다. 그 학습 데이터로 본 모델이 이 샘플에 어떤 라벨을 붙이는지 보여줄 뿐, 당신의 정체성이나 「패싱」 점수가 아닙니다.",
		"metrics.nnSegmentNote": "* 파일 전체에서 지속 시간 가중 평균. 구간 목록의 남/여 교체는 정상입니다 — 분류기는 경계에서 잡음이 많고, 다중 화자를 추적하지 않습니다.",
		"metrics.headerOverall": "파일 전체",
		"metrics.headerOverallSpeech": "파일 전체 · 발화 {dur}",
		"metrics.disclaimer.prefix": "두 오픈소스 프로젝트 위에 만들어졌습니다: 신경망 분류기는 ",
		"metrics.disclaimer.mid": "에서, 음소별 포먼트 z-score 파이프라인은 ",
		"metrics.disclaimer.forkLabel": "포크",

		// 컬럼 헤더에 짧게 표시 — 위쪽 readout 줄에는 '음높이' / '공명' 풀네임.
		"timeline.pitch": "음",
		"timeline.resonance": "공",
		...
		"timeline.pitchTitleInterp": "{char} {phone} · 음높이 {raw} (어절 {interp} Hz)",
		"timeline.resonanceTitle": "{char} {phone} · 공명 {res}",
		"timeline.ariaPitch": "음높이 히트맵; 글자별 색상 (무성 자음은 모음 색을 상속).",
		"timeline.ariaPitchDesc": "현재 페이지의 음높이 히트맵",
		"timeline.ariaResonance": "공명 히트맵; 각 셀 = 한 음소, 값 0–1.",
		"timeline.ariaResonanceDesc": "현재 페이지의 공명 히트맵. 팔레트 중앙값 = 0.5.",
		"timeline.announceReady": "분석 완료, {n}자 표시됨",
		"timeline.returnToCurrent": "현재 시점으로 돌아가기",
		"timeline.barModePhone": "음소",
		"timeline.barModeWord": "어절 평균",
		"timeline.barModeAria": "막대 단위: 음소별 / 어절별 (지속시간 가중 평균)",
		"timeline.wordAvgLabel": "어절 평균",

		"fallback.noTimelineTitle": "음소별 타임라인을 만들 수 없습니다",
		"fallback.noTimelineLead": "오디오는 받았지만 음소 정렬에 실패했습니다.",
		"fallback.commonReasons": "흔한 원인",
		"fallback.reasonTooShort": "녹음이 너무 짧음 (5초 이상 권장)",
		"fallback.reasonWrongLang": "언어 불일치 — 상단 바에서 오디오와 같은 언어로 바꾸고 다시 시도하세요",
		"fallback.reasonNoise": "배경 잡음이 너무 큼",
		"fallback.reasonNoSpeech": "녹음에 또렷한 발화가 없음",
		"fallback.tips": "팁",
		"fallback.tipQuiet": "조용한 방에서 다시 녹음하세요",
		"fallback.tipRead": "10–30초 정도 단락을 읽으세요",
		"fallback.tipMicDist": "마이크와 입 사이를 15–25 cm로 유지하세요",
		"fallback.stillVisible": "아래의 파형과 신경망 추정은 그대로 볼 수 있습니다.",
		"fallback.lowPhone": "음소 {n}개만 검출됨 — 통계가 불안정할 수 있습니다. 더 안정적인 수치를 보려면 10초 이상 연속 발화로 녹음하세요.",
		"fallback.noSpeechTitle": "발화 미검출",
		"fallback.noSpeechLead": "오디오에서 분석할 만한 발화가 없습니다. 음악이나 환경음 아닐까요?",
		"fallback.noSpeechHint": "또렷한 발화가 담긴 클립으로 다시 시도하세요.",

		"legend.azimuthAria": "공명 색상 범례",
		"legend.scienceAria": "팔레트 보정 방법",
		"legend.male": "남성 성향",
		"legend.neutral": "안드로지너스",
		"legend.female": "여성 성향",
		"legend.infoAria": "팔레트 정보",
		"legend.sci1": "<strong>공명 팔레트</strong>는 설계상 0.5를 중심으로 합니다 — 남성-차가움과 여성-따뜻함 사이 기준 코퍼스의 중앙값입니다.",
		"legend.sci2": "보정은 acousticgender.space 영어 음성 학습 코퍼스를 사용합니다; 음소별 F₂/F₃/F₄ z-score를 라벨된 화자로 망라 검색해 결정한 가중치로 결합합니다.",
		"legend.sci3": "<strong>음높이 기준:</strong> {neutral} Hz는 남성-높음 / 여성-낮음의 전형적 경계; {fem} Hz는 음성 작업에서 흔히 쓰이는 지각 임계값입니다.",
		"legend.sci4": "음높이 구간은 영어권 시스젠더 기준 인구에서 나옵니다 — 학습 목표가 아닙니다. 175 Hz 아래에서 말하는 시스 여성도 많고 여성으로 자연스럽게 들립니다. 공명은 음높이만큼 중요합니다.",
		"legend.sciNote": "색상은 방향 지표일 뿐 성별 판정이 아닙니다.",

		// Advice v2 — docs/plans/v2_redesign_measurement.md 참조
		"advice.tone.leans_feminine": "여성적 성향",
		"advice.tone.leans_masculine": "남성적 성향",
		"advice.tone.weakly_feminine": "약한 여성적",
		"advice.tone.weakly_masculine": "약한 남성적",
		"advice.tone.not_clearly_leaning": "성향이 뚜렷하지 않음",
		"advice.zone.low": "낮음",
		"advice.zone.mid_lower": "중하",
		"advice.zone.mid_neutral": "음향적 중성",
		"advice.zone.mid_upper": "중상",
		"advice.zone.high": "높음",
		"advice.warning.short_recording_minimal": "녹음이 10초 미만 — 원시 측정값만 표시합니다. 음성 성향 판단에는 10초 이상 필요합니다.",
		"advice.warning.short_recording_standard": "녹음이 짧습니다 ({duration}초) — 안정성이 제한됩니다. 안정적 결과는 30초 이상 권장.",
		"advice.warning.dismiss": "경고 숨기기",
		"advice.summary.low_leans_feminine": "F0 중앙값 {f0} Hz, 낮은 구간. 여성적 성향.",
		"advice.summary.low_leans_masculine": "F0 중앙값 {f0} Hz, 낮은 구간. 남성적 성향.",
		"advice.summary.low_weakly_feminine": "F0 중앙값 {f0} Hz, 낮은 구간. 약한 여성적.",
		"advice.summary.low_weakly_masculine": "F0 중앙값 {f0} Hz, 낮은 구간. 약한 남성적.",
		"advice.summary.low_not_clearly_leaning": "F0 중앙값 {f0} Hz, 낮은 구간. 성향이 뚜렷하지 않음.",
		"advice.summary.mid_lower_leans_feminine": "F0 중앙값 {f0} Hz, 중하 구간. 여성적 성향.",
		"advice.summary.mid_lower_leans_masculine": "F0 중앙값 {f0} Hz, 중하 구간. 남성적 성향.",
		"advice.summary.mid_lower_weakly_feminine": "F0 중앙값 {f0} Hz, 중하 구간. 약한 여성적.",
		"advice.summary.mid_lower_weakly_masculine": "F0 중앙값 {f0} Hz, 중하 구간. 약한 남성적.",
		"advice.summary.mid_lower_not_clearly_leaning": "F0 중앙값 {f0} Hz, 중하 구간. 성향이 뚜렷하지 않음.",
		"advice.summary.mid_neutral_leans_feminine": "F0 중앙값 {f0} Hz, 음향적 중성 구간. 여성적 성향.",
		"advice.summary.mid_neutral_leans_masculine": "F0 중앙값 {f0} Hz, 음향적 중성 구간. 남성적 성향.",
		"advice.summary.mid_neutral_weakly_feminine": "F0 중앙값 {f0} Hz, 음향적 중성 구간. 약한 여성적.",
		"advice.summary.mid_neutral_weakly_masculine": "F0 중앙값 {f0} Hz, 음향적 중성 구간. 약한 남성적.",
		"advice.summary.mid_neutral_not_clearly_leaning": "F0 중앙값 {f0} Hz, 음향적 중성 구간. 성향이 뚜렷하지 않음.",
		"advice.summary.mid_upper_leans_feminine": "F0 중앙값 {f0} Hz, 중상 구간. 여성적 성향.",
		"advice.summary.mid_upper_leans_masculine": "F0 중앙값 {f0} Hz, 중상 구간. 남성적 성향.",
		"advice.summary.mid_upper_weakly_feminine": "F0 중앙값 {f0} Hz, 중상 구간. 약한 여성적.",
		"advice.summary.mid_upper_weakly_masculine": "F0 중앙값 {f0} Hz, 중상 구간. 약한 남성적.",
		"advice.summary.mid_upper_not_clearly_leaning": "F0 중앙값 {f0} Hz, 중상 구간. 성향이 뚜렷하지 않음.",
		"advice.summary.high_leans_feminine": "F0 중앙값 {f0} Hz, 높은 구간. 여성적 성향.",
		"advice.summary.high_leans_masculine": "F0 중앙값 {f0} Hz, 높은 구간. 남성적 성향.",
		"advice.summary.high_weakly_feminine": "F0 중앙값 {f0} Hz, 높은 구간. 약한 여성적.",
		"advice.summary.high_weakly_masculine": "F0 중앙값 {f0} Hz, 높은 구간. 약한 남성적.",
		"advice.summary.high_not_clearly_leaning": "F0 중앙값 {f0} Hz, 높은 구간. 성향이 뚜렷하지 않음.",

		"duck.msg1": "오리가 음성을 듣고 있어요…",
		"duck.msg2": "오리가 열심히 일하는 중…",
		"duck.msg3": "오리가 귀 기울이는 중…",
		"duck.msg4": "음높이 윤곽 측정 중…",
		"duck.msg5": "포먼트 계산 중…",
		"duck.msg6": "거의 다 됐어요…",
		"duck.done": "분석 완료 🎉",
		"duck.running": "분석 중…",

		"toast.cancelled": "분석 시간이 초과되었습니다 — 더 짧은 클립으로 시도해 보세요.",
		"toast.failedFmt": "분석 실패: {msg}",
		"toast.batchFmt": "배치 완료: {ok} / {total} 성공",
		"toast.batchItemFmt": "{name} 실패: {msg}",
		"toast.confirmClear": "저장된 모든 기록을 지울까요?",
		"toast.processing": "처리 중…",
		"toast.hideFeedback": "피드백 버튼을 숨겼습니다 (URL에 ?feedback=1 을 붙이면 다시 나타납니다).",

		"progress.queued": "대기열에 있습니다 — 워커를 기다리는 중…",
		"progress.queuedNext": "곧 차례가 됩니다…",
		"progress.queuedCount": "대기열 — 앞에 {n}건",
		"progress.processing": "오디오 준비 중…",
		"progress.listening": "음성을 듣는 중… (시간이 걸립니다)",
		"progress.organizing": "청취 완료 — 메모 정리 중…",
		"progress.loadAudio": "오디오 로딩 중…",
		"progress.analyseSegment": "구간 {i}/{total} 분석 중…",
		"progress.engineCScript": "원고를 단어 단위로 정렬 중…",
		"progress.engineCFree": "음소 단위 분석 중…",
		"progress.almostDone": "거의 다 됐어요…",
		...
		"recorder.idleHint": "최대 3분 — 정지하면 바로 분석이 시작됩니다.",

		"upload.errEmpty": "파일이 비어 있습니다 — 다른 파일을 선택하세요.",
		"upload.errUnsupported": "지원하지 않는 형식: {fmt}. 오디오 파일을 업로드하세요.",
		"upload.errUnknown": "알 수 없음",
		"upload.errTooLarge": "파일이 너무 큽니다 ({mb} MB). 현재 상한: {limit} MB.",
		"upload.errNoFile": "선택된 파일이 없습니다",
		"analyzer.noTaskId": "백엔드가 task_id를 반환하지 않았습니다.",
		"analyzer.needOnProgress": "analyzeAudio는 진행 스트림 구독을 위해 onProgress 콜백을 요구합니다.",
		"analyzer.submitFailed": "요청 실패 ({status})",
		"analyzer.streamFailed": "진행 상황 구독 실패 ({status})",
		"analyzer.backendError": "백엔드 분석 오류",
		"analyzer.noResult": "결과를 받지 못했습니다",

		"audioGate.clipping": "오디오가 클리핑됩니다 ({pct} % 샘플 포화). 녹음 음량을 낮추고 다시 시도하세요.",
		"audioGate.tooQuiet": "음량이 너무 낮습니다 (RMS {db} dBFS). 마이크에 가까이 가거나 입력 게인을 올리세요.",
		"audioGate.silence": "클립이 거의 무음입니다 — 마이크가 음소거 상태가 아닌지 확인하세요.",
		"audioGate.insufficientVoicing": "검출된 발화가 부족합니다 ({pct} %). 연속 발화가 담긴 클립으로 녹음하세요.",
		...
		"help.what.h": "이게 뭔가요?",
		"help.what.p": "음향적 고정관념이 성별 지각에 어떻게 영향을 주는지 평가하기 위한 듀얼 엔진 크로스체크 사이트입니다. 음소 단위 분석과 파일 전체 분석을 모두 다룹니다. 주로 상류 프로젝트 gender-voice-visualization과 inaSpeechSegmenter (K-3 포크)를 기반으로 합니다. 베타이며 반복 중입니다. 음성 작업에 도움이 되길 바랍니다.",
		"help.flow.h": "파이프라인",
		"help.flow.s1.h": "업로드 / 녹음",
		"help.flow.s1.note": "파일을 끌어다 놓거나 선택, 또는 마이크 사용 (≤ {mb} MB, < {min}분; zh-CN / en-US / fr-FR / ko-KR).",
		"help.flow.s2.h": "VAD 분할",
		"help.flow.s2.note": "Engine A · inaSpeechSegmenter K-3가 음성 / 음악 / 무음을 분리합니다.",
		"help.flow.s3.h": "텍스트 정렬",
		"help.flow.s3.note": "Engine C · 자유 모드는 ASR (FunASR / faster-whisper)을 돌리고, 따라 읽기 모드는 원고를 그대로 씁니다. Montreal Forced Aligner가 음소 단위로 정렬합니다.",
		"help.flow.s4.h": "포먼트 + z-score",
		"help.flow.s4.note": "Praat이 F1 / F2 / F3을 추출 → z-score를 결합해 공명 값으로 만듭니다.",
		"help.flow.s5.h": "3패널 렌더링",
		"help.flow.s5.note": "파형 · 가운데 샌드위치 타임라인 · 오른쪽 전체 평균.",
		"help.how.h": "사용 방법",
		"help.how.1": "파일을 끌어다 놓거나 선택, 또는 녹음 (≤ {mb} MB, < {min}분).",
		"help.how.2": "분석을 누르고 오리 진행바를 기다리세요.",
		"help.how.3": "추가 클릭 없이 3패널이 자동으로 채워집니다.",
		"help.heatmap.h": "히트맵 안에서",
		"help.heatmap.resonanceDT": "공명",
		"help.heatmap.resonanceDD": "각 음소 안의 공명. 모음만. F1, F2, F3의 가중 결합에서 나옵니다. 기준선은 시스 음성 기준 코퍼스로 보정. 50 % 이상은 여성적 성향을 나타냅니다.",
		"help.heatmap.pitchDT": "음높이",
		"help.heatmap.pitchDD": "각 음소 안의 F0. 음성의 남성적 / 여성적 지각 사이 주요 음향 경계로 여겨집니다.",
		"help.overall.h": "전체 분석",
		"help.overall.note": "F0, 공명, 포먼트는 모두 유성음 구간 평균입니다.",
		"help.overall.nnDT": "NN / Engine A",
		"help.overall.nnDD": "inaSpeechSegmenter의 CNN 분류기로, 주로 프랑스어 방송 오디오로 학습되었습니다. 발화 구간에서 시스 음성 분포를 구분하도록 설계된 성별 라벨을 출력합니다. 대략적인 음성 성향 참고로만 다루세요.",
		"help.qa.h": "FAQ",
		"help.qa.q1": "먼저 어디를 봐야 하나요?",
		"help.qa.a1": "신경망 퍼센트가 아니라 공명 / 음높이 히트맵을 보세요. NN은 정확하지 않습니다. 「대략적인 음성 성향 참고」로 격하 중입니다. 공명과 음높이는 음소 단위 시간 해상도의 직접 측정값 — 연습을 안내해 줄 수 있는 것이 이것입니다.",
		"help.qa.q2": "세 엔진이 일치하지 않을 때는?",
		"help.qa.a2": "공명과 음높이를 믿으세요. NN과 다른 게 정상입니다 — 같은 걸 재는 게 아닙니다. 더 유용한 질문: 공명과 음높이가 서로 일치하나요? 음높이는 올랐는데 공명이 낮으면, 성대 음높이는 올라갔지만 공명강은 아직 안 바뀐 것 — 이게 다음 방향입니다.",
		"help.qa.q3": "「Other」가 뭔가요?",
		"help.qa.a3": "휴지, 호흡음, 또는 엔진이 분류하지 못한 구간입니다.",
		"help.qa.q4": "실생활에서는 여성으로 보이는데 도구는 남성이라고 — 무슨 일이죠?",
		"help.qa.a4": "도구가 틀린 겁니다. 당신은 괜찮습니다.",
		"help.qa.q5": "그럼 이 도구는 실제로 어디에 쓰나요?",
		"help.qa.a5": "각 모음의 공명과 음높이가 시간 따라 어떻게 변하는지 관찰하는 데. 「이 ‹아›는 밝게 들리는데 저 ‹아›는 무너졌네.」 귀로는 잘 안 들어오지만 히트맵이 보이게 해 줍니다.",
		"help.qa.q6": "오디오 제한은?",
		"help.qa.a6": "≤ 5 MB, < 3분. 최적: 30초 이상, 조용한 방, 단일 화자.",
		"help.qa.q7": "언어를 어떻게 바꾸나요?",
		"help.qa.a7": "오른쪽 위 버튼으로 zh-CN, en-US, fr-FR, ko-KR 사이를 전환하세요.",
		"help.qa.q8": "내 데이터는 저장되나요?",
		"help.qa.a8": "서버는 아무것도 저장하지 않습니다.",
		"help.qa.q9": "모바일에서 작동하나요?",
		"help.qa.a9": "네, 다만 타임라인은 가로 모드를 권장합니다.",
		"help.links.h": "링크",
		"help.links.projGroup": "이 프로젝트",
		"help.links.creditsGroup": "기술 크레딧",
		"help.links.repo": "GitHub 저장소",
		"help.links.issues": "문제 신고",
		"help.links.ina": "inaSpeechSegmenter (K-3 포크)",
		"help.links.gvv": "gender-voice-visualization",
		"help.links.mfa": "Montreal Forced Aligner",
		"help.links.praat": "Praat",
		"help.links.funasr": "FunASR",
