# E2E perturbation report — 2026-05-04
...
| V1 F0 +4 semi | 183 | 74.8 | 0.723 | 3 | /ow/=0.08(weak), /aj/=0.16(weak), /o/=0.24(weak), /y/=0.44(low) |
| V2 F0 -4 semi | 100 | 1.4 | 1.0 | 0 | /e/=0.45(low), /a/=0.66(good), /u/=0.86(good), /o/=1.00(good) |
| V3 formants ×1.2 | 173 | 74.4 | 0.703 | 2 | /o/=0.19(weak), /a/=0.37(weak), /ow/=0.44(low), /i/=0.56(low) |
...
| V0p baseline rerun | 196 | 98.9 | 0.965 | 0 | /AH/=1.00(good), /IY/=1.00(good), /AE/=1.00(good), /ER/=1.00(good) |
| V1 F0 +4 semi | 246 | 64.2 | 0.985 | 0 | /IY/=0.57(low), /AH/=1.00(good), /AE/=1.00(good) |
| V2 F0 -4 semi | 160 | 10.1 | 0.44 | 1 | /IY/=0.14(weak), /AH/=0.47(low), /AE/=1.00(good) |
| V3 formants ×1.2 | 234 | 66.0 | 0.832 | 0 | /AH/=1.00(good), /IY/=1.00(good) |
...
- **PASS** `determinism/en-US` — |Δf0|=0.00Hz  |Δmedian_res|=0.0090
...
- **PASS** `formant/direction.en-US` — V3=0.832 > V4=0.477
- **PASS** `formant/amplitude.zh-CN` — V3-V4=0.284 (need ≥ 0.05)
- **PASS** `formant/amplitude.en-US` — V3-V4=0.355 (need ≥ 0.05)
